...
public class Kit {
	...
	public ArrayList<Kit> getCourseSpecificKitDetails(Course course){
		...
		//String hql = "FROM Kit K WHERE K.semester ='"+ course.getSemester()+"'"+" AND K.year ='"
		//+ course.getYear()+"'"+"AND K.kitCourse ='" + course.getCourseName() +"'";
		String hql = "FROM Kit K WHERE AND K.courseName ='" + course.getCourseName() +"'";

		//String hql = "FROM Kit K WHERE K.semester = Fall";  
